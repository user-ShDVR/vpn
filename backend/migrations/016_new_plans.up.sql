...
VALUES
  ('Базовый',         30,  600, 3, 20000,  1, '600 ГБ трафика, 3 устройства, 1 локация'),
  ('Премиум',         30,  600, 6, 35000,  2, '600 ГБ трафика, 6 устройств, 2 локации'),
  ('Базовый годовой', 365, 600, 3, 200000, 1, 'Базовый на 12 месяцев — выгода 17%'),
  ('Премиум годовой', 365, 600, 6, 350000, 2, 'Премиум на 12 месяцев — выгода 17%')
