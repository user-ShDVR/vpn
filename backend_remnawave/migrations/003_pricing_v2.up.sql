...
FROM (VALUES
  ('Суточный', '📅', 1,  3,   1, 1500::bigint,   'DAY',   790::bigint,  1,
  ...
  ('Базовый',  '◆',  30, 20,  1, 15900::bigint,  'MONTH', 790::bigint,  1,
   'Безлимитный трафик на стандартных VPN-серверах. Трафик серверов мобильного обхода учитывается отдельно — 20 ГБ включено в тариф. Подключение 1 устройства. Доп. трафик — 79 ₽ за 10 ГБ.'),
  ('Стандарт', '⚡', 30, 50,  2, 27900::bigint,  'MONTH', 790::bigint,  1,
   'Безлимитный трафик на стандартных VPN-серверах. Трафик серверов мобильного обхода учитывается отдельно — 50 ГБ включено в тариф. Подключение до 2 устройств. Доп. трафик — 79 ₽ за 10 ГБ.'),
  ('Премиум',  '💎', 30, 100, 3, 44900::bigint,  'MONTH', 790::bigint,  1,
   'Безлимитный трафик на стандартных VPN-серверах. Трафик серверов мобильного обхода учитывается отдельно — 100 ГБ включено в тариф. Подключение до 3 устройств. Доп. трафик — 79 ₽ за 10 ГБ.'),
  ('Максимум', '👑', 30, 250, 10, 113400::bigint, 'MONTH', 790::bigint,  2,
   'Безлимитный трафик на стандартных VPN-серверах. Трафик серверов мобильного обхода учитывается отдельно — 250 ГБ включено в тариф. Подключение до 5 устройств. Доп. трафик — 79 ₽ за 10 ГБ.')
